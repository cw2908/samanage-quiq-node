...
describe("Route Handler", () => {
  describe("/api/samanage route", () => {
    // it("returns success given an event with requester email", () => {
    //   request(app)
    //     .post("/api/samanage")
    //     .send(mockReq)
    ...
    //     })
    // })
    // it("returns failure given an event without requester email", () => {
    //   request(app)
    //     .post("/api/samanage")
    //     .send(mockNoEmailReq)
    //     .set("Accept","application/json")
    ...
    // it(" 400 status code if given invalid event data", () => {
